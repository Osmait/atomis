...
class InstrumentTests(unittest.TestCase):
    def test_probes_simple_assignments_top_level_included(self):
        ...
        self.assertIn('price = 40; __ziglive_probe("', generated)
        self.assertIn('"price", price)', generated)
        self.assertIn('tax: int = 3; __ziglive_probe("', generated)
        self.assertIn('inner = price + tax; __ziglive_probe("', generated)
    ...
    def test_multiline_statement_inserts_after_the_closing_line(self):
        result = instrument(SAMPLE, "file:///main.py", True, [], 1)
        self.assertIn(']; __ziglive_probe("', result["generated"])

    def test_log_markers_track_loops(self):
        result = instrument(SAMPLE, "file:///main.py", True, [], 7)
        generated = result["generated"]
        self.assertIn(
            '; __ziglive_log_loop(1, 7, 11, 5, 10, 1, "i", i)', generated
        )
        self.assertIn("; __ziglive_log(1, 7, 14, 1)", generated)
    ...
    def test_manual_mode_inserts_only_selected(self):
        ...
        self.assertNotIn("__ziglive_probe", none["generated"])
        selected = instrument(
    ...
    def test_instrumented_source_passes_through(self):
        source = 'x = 1; __ziglive_probe("a", 1, 1, "x", x)\n'
